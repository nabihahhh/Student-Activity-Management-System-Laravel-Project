    ...
    <div class="p-4 shadow-md rounded-md text-left bg-gray-50 flex-auto" style="max-width: max-content object-position: right">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('report.post.step.1') }}" method="POST">
                    @csrf
                    <div class="form-group">

                        <label for="name">
                            <span class="text-gray-700">1. Name of Programme</span>
                         </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="programmeName" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.programmeName)') }}">
                        <br>

                        <label for="name">
                            <span class="text-gray-700">2. Organiser</span>
                        </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="programmeOrganizer" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.programmeOrganizer)') }}">
                        <br>

                        <label for="name">
                            <span class="text-gray-700">3. Date</span>
                        </label>
                        <input class="form-input mt-1 block w-1/4" type="date" name="date" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.date)') }}">
                        <br>

                        <label for="name">
                            <span class="text-gray-700">4. Venue</span> 
                        </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="venue" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.venue)') }}">
                        <br>

                        <label for="name">
                            <span class="text-gray-700">5. No. of Participants</span>
                        </label><br>
                        Local <input class="form-input mt-1 block w-1/4" type="number" name="localParticipant" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.localParticipant)') }}">
                        International<input class="form-input mt-1 block w-1/4" type="number" name="internationalParticipant" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.internationalParticipant)') }}">
                        Outsider<input class="form-input mt-1 block w-1/4" type="number" name="outsiderParticipant" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.outsiderParticipant)') }}">
                        <br>

                        <label for="name">
                        <span class="text-gray-700">6. Accompanying Officer</span>
                        </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="accompanyingOfficer" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.accompanyingOfficer)') }}">
                        <br>

                        <label for="name">
                        <span class="text-gray-700">7. Budget Spent</span>
                        </label>
                        <input class="form-input mt-1 block w-1/4" type="text" name="budgetSpent" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.budgetSpent)') }}">
                        Outside Sponsorship<input class="form-input mt-1 block w-1/4" type="text" name="outsideSponsorship" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.outsideSponsorship)') }}">
                        <br>

                        <label for="name">
                        <span class="text-gray-700">8. Collaborations</span>
                        </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="collaborations" class="form-control mb-2" placeholder="Enter" value="{{ session()->get('report.collaborations)') }}">
                        <br>

                        <label for="name">
                        <span class="text-gray-700">9. VIP' Attended (Please mention session)</span>
                        </label>
                        <input class="form-input mt-1 block w-3/4" type="text" name="vipAttended" class="form-control mb-2" placeholder="Enter " value="{{ session()->get('report.vipAttended)') }}">
                        <br><br>
