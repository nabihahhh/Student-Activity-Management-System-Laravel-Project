<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 bg-gray-900 ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-900 sidebar">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('signup')" :active="request()->routeIs('signup')">
                        {{ __('Create new programme report') }}
                    </x-nav-link>
                </div>
                @endif
                @if (Auth::user()->hasRole('organizer'))
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('signup1')" :active="request()->routeIs('signup1')">
                        {{ __('Create new programme proposal') }}
                    </x-nav-link>
                </div>
                @endif
