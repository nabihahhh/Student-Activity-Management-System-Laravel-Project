  ...
  <div class="min-w-screen min-h-screen bg-gray-100 flex-auto justify-center bg-gray-100 font-sans overflow-hidden">
    ...
    <tr>   
      <th>&nbsp;</th>
        ...
        <th class="bg-green-700 text-white text-center shadow-md rounded-md text-sm">PROGRESS SUBMITTED FORMS - PROGRAMME REPORT FORM (PRF)</th>
